    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('latestBid', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='ltBid', to='auctions.Bid')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('listings', models.ManyToManyField(blank=True, related_name='watch', to='auctions.Listing')),
